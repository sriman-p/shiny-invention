...
class TestRequirement:
    def test_valid_functional_requirement(self):
        r = Requirement(
            id="REQ-001",
            title="Add numbers",
            description="Calculator adds two numbers",
            type="functional",
            priority="high",
...
class TestCodeSymbol:
    ...
    def test_valid_class(self):
        s = CodeSymbol(
            qualified_name="src.calc.Calculator",
            kind="class",
            file_path="src/calc.py",
            line_start=1,
            line_end=40,
...
class TestPipelineChain:
        ...
        return ParseOutput(
            requirements=[
                ...
                Requirement(
                    ...
                    type="functional",
                    priority="high",
                    acceptance_criteria=["5-3=2"],
                    source_location="req.md:L10",
                ),
            ],
    ...
    def test_map_output_nests_analyze(self):
        ...
        m = MapOutput(
            ...
            mappings=[
                ...
                Mapping(requirement_id="REQ-002", symbol=None, confidence=0.0, rationale="No matching symbol found"),
            ],
        )
    ...
    def test_generate_output_nests_map(self):
        ...
        g = GenerateOutput(
            ...
            tests=[
                GeneratedTest(
                    requirement_id="REQ-001",
                    file_path="test_add.py",
                    code="def test_add(): assert Calculator().add(2,3) == 5",
                    target_symbol="calc.Calculator.add",
                    rationale="Test basic addition",
                ),
            ],
        )
    ...
    def test_trace_output_full_chain(self):
        ...
        t = TraceOutput(
            ...
            matrix=[
                TraceabilityRow(
                    requirement_id="REQ-001", symbol="calc.add", test_files=["test_add.py"], coverage_status="covered"
                ),
                TraceabilityRow(requirement_id="REQ-002", symbol=None, test_files=[], coverage_status="uncovered"),
            ],
    ...
    def test_full_chain_serialization(self):
        ...
        crit = CritiqueOutput(
            ...
            scores=[
                CritiqueScore(
                    test_file="t.py", relevance=5, completeness=5, correctness=5, decision="accept", notes="Perfect"
                ),
            ],
        )
        trace = TraceOutput(
            ...
            matrix=[
                TraceabilityRow(
                    requirement_id="REQ-001", symbol="calc.add", test_files=["t.py"], coverage_status="covered"
                ),
            ],
